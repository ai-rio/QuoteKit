...
export const metadata: Metadata = {
  title: 'LawnQuote Software',
  description: 'Professional quote management system for landscaping and lawn care businesses',
};
    ...
    <footer className='mt-8 flex flex-col gap-8 text-neutral-400 lg:mt-32'>
      ...
      <div className='border-t border-zinc-800 py-6 text-center'>
        <span className='text-neutral4 text-xs'>
          Copyright {new Date().getFullYear()} © LawnQuote Software
        </span>
      </div>
    </footer>
  );
