...
const BREADCRUMB_SEGMENTS: Record<string, BreadcrumbSegment> = {
  ...
  assessments: { path: "/assessments", label: "Assessments", icon: FileText },
  "assessments/new": { path: "/assessments/new", label: "New Assessment", icon: FileText },
  "assessments/[id]": { path: "", label: "Assessment Details", icon: FileText, dynamic: true },
  "assessments/[id]/edit": { path: "", label: "Edit Assessment", icon: FileText, dynamic: true },
