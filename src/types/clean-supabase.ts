...
// ============================================================================
// 8. BACKWARD COMPATIBILITY TYPES
// ============================================================================

// Legacy subscription type for gradual migration
export interface LegacySubscription {
  id: string
  internal_id?: string // Deprecated
  user_id: string
  stripe_subscription_id: string | null
  stripe_customer_id: string | null
  price_id: string // Maps to stripe_price_id
  status: SubscriptionStatus
  quantity: number
  current_period_start: string
  current_period_end: string
  cancel_at_period_end: boolean
  created: string // Maps to created_at
  updated_at: string
  prices?: {
    id?: string
    stripe_price_id: string
    ...
    currency: string
    recurring_interval: RecurringInterval | null
    interval?: RecurringInterval | null // Backward compatibility
    type?: 'recurring' | 'one_time' // Backward compatibility
