-- Recreate admin users after clearing the system
-- This creates fresh admin users with proper authentication

-- Insert test admin user directly into auth.users
...
-- Create company profiles for both admin users
